        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full self-start px-4 lg:px-16 lg:w-1/2">
                    <h1 class="text-sm font-semibold text-primary md:text-base mb-4">Hello! I'm Idrees —
                    </h1>
                    <div class="mb-4 lg:mb-6">
                        <span class="font-bold text-dark text-3xl mb-2 lg:text-4xl tracking-tight block">I'm a Full Stack Web
                            Developer</span>
                    </div>
                    <div class="grid grid-flow-col justify-start">
                        <a href="mailto:idreesdweik@gmail.com"
                    ...
                    <div class="mt-8">
                        <p class="text-base text-gray-600">I am a Developer graduate from <a href="https://aqaba.ju.edu.jo/" target="_blank" class="self-center text-xl text-primary font-bold uppercase">JU</a>
                            with a Bachelor's Degree in Business Information Technology
                            . Always have motivation to learning and improve new skill. I look forward to
                            providing
                    ...
                    <div class="mt-8">
                        <div class="flex items-center justify-left mt-6">
                            <!-- Linkedin -->
                            <a href="https://www.linkedin.com/in/idrees-dweik/"
                            ...
                            <!-- Github -->
                            <a href="https://github.com/IdreesDweik"
                                class="inline-flex items-center justify-center w-10 h-10 mr-2 text-dark" target="_blank">
                                <svg role="img" fill="#6b7280" class="h-5 w-5 hover:opacity-80" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <title>GitHub</title>
            ...
            <div class="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-gray-600 lg:px-16" data-aos="fade-down">
                ...
                <div class="flex flex-row-reverse md:contents">
                    <div class="bg-white col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
                        <h3 class="font-semibold text-base md:text-lg mb-1">The University of Jordan</h3>
                        <h4 class="font-normal text-sm mb-1 text-gray-400">2014-2018</h4>
                        <p class="leading-tight text-justify text-base">
                            Bachelor's Degree in Business Information Technolog
                        </p>
                    </div>
                ...
                <div class="flex md:contents">
                    ...
                    <div class="bg-white col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
                        <h3 class="font-semibold text-base md:text-lg mb-1">Coding Academy by Orange</h3>
                        <h4 class="font-normal text-sm mb-1 text-gray-400">2023</h4>
                        <p class="leading-tight text-justify text-base">
